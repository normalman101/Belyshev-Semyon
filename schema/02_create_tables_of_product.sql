...
(
    id              INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
    type_id         INTEGER                                              NOT NULL REFERENCES table_product_types (id),
    unit_id         INTEGER                                              NOT NULL REFERENCES table_units (id),
    manufacturer_id INTEGER                                              NOT NULL REFERENCES table_manufacturers (id),
    name            TEXT                                                 NOT NULL CHECK ( name != '' ),
...
CREATE TABLE table_product_price_change_history
(
    id            INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
